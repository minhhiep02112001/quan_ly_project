                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <th class="text-center">Kinh phí thực tế</th>
                                    <th class="text-center">Kinh phí</th>
                                    <th class="text-center">Biểu đồ tiến độ </th>
                                    <th>Ghi chú</th>
                                    <th>Onwer</th>
                                    <th></th>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center"><span class="badge bg-green">hoàn thành</span></td>
                                    <td class="text-center">12-5-2022</td>
                                    <td class="text-center">12-5-2022</td>
                                    <td class="text-center">900.000.000 vnd</td>
                                    <td class="text-center">800.000.000 vnd</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><span class="badge bg-light-blue">đang thực hiện</span></td>
                                    <td class="text-center">12-5-2022</td>
                                    <td class="text-center">12-5-2022</td>
                                    <td class="text-center">900.000.000 vnd</td>
                                    <td class="text-center">800.000.000 vnd</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><span class="badge bg-red">đã hủy</span></td>
                                    <td class="text-center">12-5-2022</td>
                                    <td class="text-center">12-5-2022</td>
                                    <td class="text-center">900.000.000 vnd</td>
                                    <td class="text-center">800.000.000 vnd</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><span class="badge bg-yellow">bắt đầu</span></td>
                                    <td class="text-center">12-5-2022</td>
                                    <td class="text-center">12-5-2022</td>
                                    <td class="text-center">900.000.000 vnd</td>
                                    <td class="text-center">800.000.000 vnd</td>
